...
variant count fixed at 100{,}000 and varied the number of samples (haplotypes) from 100 to
100{,}000; for variant-count scaling
we held sample size at 200 samples and varied \msprime simulated
\citep{baumdicker2022} sequence length to carry from $\sim 10^3$ to
