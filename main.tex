...
established CPU tools and \pggpu. \checkmark, full support;
$\sim$, partial or restricted support; ---, no support or out of
scope. Statistic categories follow the broad families described in
the text. \moments \citep{jouganous2017} is omitted because its
scope is downstream demographic inference rather than genome-scale
...
\textbf{Tool}
 ...
 & \textbf{Local PCA}
 & \textbf{GPU} \\
 & & \textbf{\& SFS} & \textbf{\& $F$-stats} & & \textbf{scans} & & \textbf{/ \lostruct} & \\
\midrule
...
\angsd \citep{korneliussen2014}
 & C++         & \checkmark & \checkmark & ---        & $\sim$     & $\sim$     & ---        & ---        \\
\scikitallel\textsuperscript{b} \citep{miles2024}
 & Python      & \checkmark & \checkmark & $\sim$     & \checkmark & \checkmark & ---        & ---        \\
\pixy \citep{korunes2021}
 & Python      & $\sim$     & $\sim$     & ---        & ---        & ---        & ---        & ---        \\
\tskit \citep{jeffery2026}
 & Python / C  & \checkmark & \checkmark & $\sim$     & ---        & \checkmark & ---        & ---        \\
\pggpu (this work)
 & Python / CUDA & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
\bottomrule
\end{tabular}
\par\smallskip
