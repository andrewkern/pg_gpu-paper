...
SFS per population, plus a joint SFS, Garud's $H$, and an LD
decay curve on smaller per-population subsamples where the
underlying kernels cap sample size---finishes in about 16 minutes
on a single A100 80\,GB. GPU memory use stays around 12\,GB
...
column, top to bottom: joint SFS on a 200-haplotype subsample
per population (a full joint SFS of 100{,}000 by 100{,}000 cells
is impractical to display); mean $r^2$ vs.\ distance between
