...
data bias in estimates of $\pi$, $d_{XY}$, $F_{ST}$, Tajima's $D$, and Watterson's
$\theta$, but is limited to those five statistics.
...
generalized theta \comment{$\theta$?} framework of \citet{achaz2009} to efficiently derive all
