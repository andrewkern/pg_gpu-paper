...
to a small display grid via per-variant hypergeometric sampling,
plus Garud's $H$ and an LD decay curve on smaller per-population
subsamples where the underlying kernels cap sample size---finishes
in about 16 minutes on a single A100 80\,GB. GPU memory use
stays around 12\,GB regardless of how long the chromosome is.
